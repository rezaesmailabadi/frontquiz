  ...
  const onSubmitChange = async (e) => {
    ...
    try {
      const responce = await axios.post(
        "http://127.0.0.1:8000/api/add_new_category",
        userField
      );
                 ...
                 <div class="row">
                     <div class="col-sm-12">
                         <div class="form-group">
                             ...
                             {/* {{ csrf_field()}} */}
                             <input type="text" required="required" name="name" placeholder="Enter category name" class="form-control" onChange={(e) => changeUserFieldHandler(e)}/>
                         </div>
                     </div>
                     <div class="col-sm-12">
                         <div class="form-group">
